...
import { BackgroundColor, EUiVariant, RingColor, TUiVariant } from "~/core/types/ui-variants.type";
...
export default function Button(props: TButtonProps) {
  ...
  return (
    <KButton.Root
      class={cls({
        "flex items-center rounded ring-offset-1 focus:ring-2 outline-none w-full sm:w-fit": true,
