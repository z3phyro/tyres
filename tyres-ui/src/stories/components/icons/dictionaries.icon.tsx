...
export default function DictionariesIcon(props: IconProps) {
  return (
    <svg
      class={props.class}
      width="800px"
      ...
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M29 10V30C29 30 29 31 28 31H4C4 31 3 31 3 30V5C3 9 7 9 7 9V17L10 15L13 17V9H27H28C28 9 29 9 29 10Z"
        fill="#FFC44D"
      />
      <path
